...
'''
My guess for what Dijkstra's is when we have a source and terminal node:
    Same as single-source Dijkstra but we stop as soon as we visit the terminal node.
'''
class Dijkstra:
